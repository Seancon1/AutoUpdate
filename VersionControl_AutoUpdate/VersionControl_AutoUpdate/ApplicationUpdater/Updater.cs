...
namespace VersionControl_AutoUpdate.ApplicationUpdater
{
    class Updater
    {
        public Updater()
        ...
        public static void DoProcess()
        {
            ...
            string urlFromSite = "https://www.prestigecode.com/projects/autoupdate/releases/Antilobby_new.exe";

            //solution from stackoverflow https://stackoverflow.com/a/29185200
            //Saves newest file from online to current directory
            using (WebClient wc = new WebClient())
            {
                wc.DownloadFile(urlFromSite, System.Environment.CurrentDirectory + "/Antilobby_new.exe");
                long timeNumber = DateTimeOffset.UtcNow.ToUnixTimeSeconds();
                File.Replace("Antilobby" + "_new" + ".exe", System.AppDomain.CurrentDomain.FriendlyName, "" + timeNumber);
